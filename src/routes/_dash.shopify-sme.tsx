...
export const Route = createFileRoute("/_dash/shopify-sme")({
  head: () => ({
    meta: [
      { title: "Shopify SME — Handover — Onboarding/Integrations Command Center" },
      { name: "description", content: "Shopify SME and Enterprise onboarding pipeline." },
      { property: "og:title", content: "Shopify SME — Handover — Onboarding/Integrations Command Center" },
