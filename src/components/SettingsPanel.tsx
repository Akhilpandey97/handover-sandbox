...
const FIELD_GROUPS: LabelGroup[] = [
  {
    ...
    keys: [
      ...
      { key: "field_contact_email", label: "Merchant Contact Email Label" },
  ...
  },
  {
    ...
    keys: [
      ...
      { key: "field_sow_link", label: "SOW Link Label" },
    ],
  },
  {
    title: "Date Labels",
  ...
  {
    title: "Credential Labels",
    description: "Labels for the sandbox, production, MCP and KwikPass fields on a project",
    keys: [
      { key: "field_sandbox_mid", label: "Sandbox MID Label" },
      { key: "field_sandbox_app_id", label: "Sandbox App ID Label" },
      { key: "field_sandbox_app_secret", label: "Sandbox App Secret Label" },
      { key: "field_sandbox_base_url", label: "Sandbox Base URL Label" },
      { key: "field_sandbox_config_id", label: "Sandbox Config ID Label" },
      { key: "field_sandbox_kwikpass_jwe_key", label: "Sandbox KwikPass JWE Key Label" },
      { key: "field_payment_simulator_link", label: "Payment Simulator Link Label" },
      { key: "field_prod_mid", label: "Production MID Label" },
      { key: "field_prod_app_id", label: "Production App ID Label" },
      { key: "field_prod_app_secret", label: "Production App Secret Label" },
      { key: "field_prod_base_url", label: "Production Base URL Label" },
      { key: "field_prod_config_id", label: "Production Config ID Label" },
      { key: "field_prod_kwikpass_jwe_key", label: "Production KwikPass JWE Key Label" },
      { key: "field_mcp_config_id", label: "MCP Config ID Label" },
      { key: "field_mcp_enabled", label: "Enable MCP Toggle Label" },
      { key: "field_kp_enabled", label: "Enable KP Toggle Label" },
      { key: "field_kp_prod_jwe_key", label: "KP Production JWE Key Label" },
      { key: "field_kp_sandbox_jwe_key", label: "KP Sandbox JWE Key Label" },
    ],
  },
  {
    title: "Notes Labels",
